...
Możesz też po prostu otworzyć feed:
- [Otwórz feed.xml]({{ '/feed.xml' | relative_url }})

## Jak korzystać z kanału RSS?

RSS działa w czytnikach takich jak:

- Feedly (działa w przeglądarce)
- NetNewsWire (popularny na macOS / iOS)
- Mozilla Thunderbird (klient poczty z wbudowaną obsługą RSS)
