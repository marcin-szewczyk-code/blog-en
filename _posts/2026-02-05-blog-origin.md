...
The easiest way to browse the content is through the [Categories](/categories/) or [Archive](/archives/) sections.

The blog offers [RSS subscription](/rss/), two language versions ([PL](https://blog.marcinszewczyk.net/) \| [EN](https://en.blog.marcinszewczyk.net/)), and a light/dark mode toggle in the header. There is also a [NEWSLETTER](/newsletter/) with notifications about new posts.
