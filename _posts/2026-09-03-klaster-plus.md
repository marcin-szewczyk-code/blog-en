---
title: "KLASTER+ Project Website"
date: 2026-09-03 07:00:00 +0200
categories: [Projects, KLASTER+]
tags: [KLASTER+, Jekyll, GitHub Pages]
---

Based on the architecture and code of my blog, I developed and launched the website for the **KLASTER+** project.

The website is static and was built with **Jekyll**, using the **Chirpy** theme. The source code and content are stored in GitHub repositories, while publication is handled through the **GitHub Pages** hosting service.

The website is available in two language versions, hosted on separate subdomains:
...
Changes to the content and code are version-controlled on **GitHub**, and once approved, new versions of the website are automatically published through **GitHub Pages**.
